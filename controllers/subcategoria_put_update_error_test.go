...
func (u updFailOrm) Delete(v interface{}, cols ...string) (int64, error) { return u.base.Delete(v, cols...) }
...
func TestSubcategoriaController_Put_UpdateFails(t *testing.T) {
    ...
    ctx := context.NewContext(); ctx.Reset(w, r); ctx.Input.RequestBody = []byte(`{"nombre":"Y"}`)
