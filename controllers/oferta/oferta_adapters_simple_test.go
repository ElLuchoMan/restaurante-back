...
// TestOfertOrmAdapter_Simple_Coverage cubre los métodos del adapter de ORM con llamadas simples
...
// TestOfertQSAdapter_Simple_Coverage cubre los métodos del adapter de QuerySeter
