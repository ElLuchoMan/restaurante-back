...
func TestProductoPedidoUpdate_ZeroDelta_ContinueBranch(t *testing.T) {
	...
	MockQuery = func(_ stdctx.Context, q string, _ []driver.NamedValue) (driver.Rows, error) {
		...
		if strings.Contains(lower, "detalle_pedido") && !strings.Contains(lower, "insert into") {
			...
			vals := [][]driver.Value{{int64(1), int64(1), int64(1), int64(2), int64(1000)}, {int64(2), int64(1), int64(2), int64(2), int64(500)}}
