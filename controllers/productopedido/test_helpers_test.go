...
type txWrapper struct{ orm.TxOrmer }

func (t txWrapper) Commit() error {
	if MockTxCommitErr != nil {
		return MockTxCommitErr
	}
	return t.TxOrmer.Commit()
}
...
func TestMain(m *testing.M) {
	...
	productoPedidoBeginTx = func(o orm.Ormer) (orm.TxOrmer, error) {
		...
		return txWrapper{TxOrmer: baseTx}, nil
	}
	os.Exit(m.Run())
}
